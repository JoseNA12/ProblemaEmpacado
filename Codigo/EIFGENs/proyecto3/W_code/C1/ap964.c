...
extern EIF_TYPED_VALUE F964_7146(EIF_REFERENCE);
...
extern EIF_TYPED_VALUE F964_7158(EIF_REFERENCE, EIF_TYPED_VALUE);
...
extern void F964_7161(EIF_REFERENCE, EIF_TYPED_VALUE);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 963, Current, 4, 0, 13424);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(4994, dtype))(Current, ui4_1x)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	ur1 = RTCCL(tr1);
	...
	RTHOOK(15);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(4969, "print_secuencia", loc3))(loc3);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(16);
	RTDBGLE;
...
/* {APPLICATION}.bandera */
EIF_TYPED_VALUE F964_7146 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
	r.it_b = *(EIF_BOOLEAN *)(Current + RTWA(4981,Dtype(Current)));
	return r;
}
...
#define Result RTOTRB(EIF_INTEGER_32)
	RTOTDB(EIF_INTEGER_32, F964_7153);
	...
	RTEAA(l_feature_name, 963, Current, 0, 0, 13432);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(963, Current, 13432);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
#define Result RTOTRB(EIF_INTEGER_32)
	...
	RTEAA(l_feature_name, 963, Current, 0, 0, 13433);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(963, Current, 13433);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x10000000, 1,0); /* Result */
...
EIF_TYPED_VALUE F964_7158 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 963, Current, 2, 1, 13437);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 963, Current, 1, 1, 13438);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 963, Current, 4, 1, 13439);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	*(EIF_INTEGER_32 *)tr1 = ((EIF_INTEGER_32) 1L);
	...
	for (;;) {
		...
		loc3 = *(EIF_INTEGER_32 *)(Current + RTWA(4984, dtype));
...
void F964_7161 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_i4
	...
	RTEAA(l_feature_name, 963, Current, 0, 1, 13440);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 4983, 0x10000000, 1); /* tamanio_cajas */
...
#define arg1 arg1x.it_i4
	...
	RTEAA(l_feature_name, 963, Current, 0, 1, 13441);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
body:;
	RTHOOK(3);
	RTDBGAA(Current, dtype, 4984, 0x10000000, 1); /* tamanio_maximo_objetos */
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 4985, 0x10000000, 1); /* semilla */
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 4986, 0x10000000, 1); /* numero_objetos */
...
body:;
	if (RTAL & CK_ENSURE) {
		in_assertion = ~0;
		ti4_2 = *(EIF_INTEGER_32 *)(Current + RTWA(4987, dtype));
		ti4_1 = ti4_2;
		in_assertion = 0;
	}
	RTHOOK(2);
	RTDBGAA(Current, dtype, 4987, 0x10000000, 1); /* id_actual_objeto */
...
void F964_7166 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 963, Current, 0, 0, 13445);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	ui4_1 = ti4_1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(4996, dtype))(Current, ui4_1x);
	RTHOOK(2);
...
void F964_7167 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 963, Current, 0, 0, 13446);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
void F964_7169 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 4981, 0x04000000, 1); /* bandera */
	*(EIF_BOOLEAN *)(Current + RTWA(4981, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
	for (;;) {
		RTHOOK(2);
		tb1 = *(EIF_BOOLEAN *)(Current + RTWA(4981, dtype));
		...
		RTHOOK(4);
		RTDBGAA(Current, dtype, 4982, 0x10000000, 1); /* entrada_usuario */
		ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5003, dtype))(Current)).it_i4);
		*(EIF_INTEGER_32 *)(Current + RTWA(4982, dtype)) = (EIF_INTEGER_32) ti4_1;
		RTHOOK(5);
		...
		if ((EIF_BOOLEAN) (ti4_1 > ((EIF_INTEGER_32) 0L))) {
			...
			RTHOOK(8);
			RTDBGAA(Current, dtype, 4981, 0x04000000, 1); /* bandera */
			*(EIF_BOOLEAN *)(Current + RTWA(4981, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
		} else {
			RTHOOK(9);
			ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(4982, dtype));
...
void F964_7173 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 963, Current, 1, 1, 13423);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTDBGAL(Current, 1, 0x10000000, 1, 0); /* loc1 */
	ur1 = RTCCL(arg1);
	loc1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(4993, dtype))(Current, ur1x)).it_i4);
	RTHOOK(2);
