...
static const struct desc_info desc_963[] = {
	...
	{EIF_GENERIC(egt_13_963), 13402, 0},
	{EIF_GENERIC(egt_14_963), 13403, 8},
	{EIF_NON_GENERIC(0x01B3 /*217*/), 13404, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x01B3 /*217*/), 13405, 0xFFFFFFFF},
	{EIF_GENERIC(egt_15_963), 13406, 0xFFFFFFFF},
	...
	{EIF_GENERIC(egt_16_963), 13410, 0xFFFFFFFF},
	{EIF_GENERIC(egt_17_963), 13391, 0xFFFFFFFF},
	...
	{EIF_GENERIC(egt_18_963), 13419, 0xFFFFFFFF},
};
void Init963(void)
{
	IDSC(desc_963, 0, 962);
	...
	IDSC(desc_963 + 52, 356, 962);
	IDSC(desc_963 + 54, 357, 962);
}
